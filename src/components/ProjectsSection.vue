    ...
    <div class="container mx-auto px-4 relative z-10">
      <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-12">
        <div class="mb-6 md:mb-0">
          ...
          <h2 class="text-3xl md:text-4xl font-bold mb-4">Latest Projects</h2>
          <p class="text-xl text-foreground/70 dark:text-foreground/60 max-w-2xl">
            Our leadership team and project management professionals have played key roles in the success of numerous 
            mega projects across the Middle East.
          </p>
        </div>
              ...
              <div class="overflow-hidden rounded-lg bg-white dark:bg-card shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group">
                <div class="aspect-[16/9] relative overflow-hidden">
                  ...
                  <div class="absolute top-4 start-4 flex gap-2">
                    <Badge class="bg-primary text-white hover:bg-primary/90">{{ project.category }}</Badge>
                    <Badge variant="outline" class="bg-white/90 backdrop-blur-sm border-white/30 dark:bg-black/50 dark:border-white/10 dark:text-white">{{ project.location }}</Badge>
                  </div>
