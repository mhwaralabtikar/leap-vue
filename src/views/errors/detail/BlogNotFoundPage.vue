<template>
  <div :dir="$i18n.locale === 'ar' ? 'rtl' : 'ltr'">
    <!-- SEO MetaTags -->
    <Head>
      <title>{{ $t('errors.detailPages.blog.title') }} | LEAP PM</title>
      <meta name="description" :content="$t('errors.detailPages.blog.description')" />
      <meta name="robots" content="noindex, follow" />
      <link rel="canonical" :href="`${siteUrl}/blog/not-found`" />
    </Head>
        ...
        <div class="max-w-md mx-auto text-center">
          ...
          <div class="relative inline-block">
            ...
            <div class="absolute inset-0 flex items-center justify-center">
              <FileXIcon class="h-24 w-24 text-primary/60" />
            </div>
          </div>
          
          <!-- Error message -->
          <h1 class="mt-8 text-2xl md:text-3xl font-bold">{{ $t('errors.detailPages.blog.heading') }}</h1>
          <p class="mt-4 text-muted-foreground">{{ $t('errors.detailPages.blog.message') }}</p>
          ...
          <div class="mt-10 flex flex-col md:flex-row gap-4 justify-center">
            ...
            >
              ...
              {{ $t('blog.viewAllArticles') || $t('blog.title') }}
            </Button>
...
import { FileXIcon, SearchIcon, HomeIcon, NewspaperIcon } from 'lucide-vue-next'
